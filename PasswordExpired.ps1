...
{   
    ...
    if(($expirationMessage -ne "") -and ($emailTo -ne $null)){
            ...
            <ol>
              ...
              <li>If you are working remotely from home, connect to your standard VPN as always:                 <ul>                   <li>FortiCLient --> Open FortiClient Console and then connect to VPN config.</li>                   <li>Check twice correct connection in FortiClient.</li>                  </ul>               </li>
             <li>Reset your computer password.
                <ul>
                <br>
                 <li>For MacOS: Apple menu -> system preferences -> users and groups -> change password.</li>                   <ul><li> KB Apple - https://support.apple.com/pl-pl/guide/mac-help/mchlp1550/mac</li></ul>
                  <br>
                 <li>For Windows: Select Start -> Settings -> Accounts -> Sign-in options -> Select Reset password.</li>                  <ul><li> KB Windows - https://support.microsoft.com/en-us/windows/change-or-reset-your-windows-password-8271d17c-9f9e-443f-835a-8318c8f68b9c</li></ul>                 </ul>                </li>
